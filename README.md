...
'Cause why not? I really like JavaScript and the power that it possesses amazes me. Each day, I'll be doing a JS (Vanilla JS) exercise from [Wes Bos'](https://github.com/wesbos/JavaScript30) JavaScript30 Challenge.
